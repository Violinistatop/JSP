...
Descrição
O exercício consiste em criar um formulário web utilizando JSP para preencher informações básicas de um currículo, como dados pessoais, experiência, habilidades e educação. O objetivo principal foi entender e aplicar conceitos fundamentais de JSP, como:
